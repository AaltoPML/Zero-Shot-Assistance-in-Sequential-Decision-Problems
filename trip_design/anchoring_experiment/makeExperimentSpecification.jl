...
user_models_not_modeled_assumed = Array{Array{Pair{FoviatedHumanWorldModelSpecification,BoltzmannUserModelSpecification},1},1}()
...
for _ in 1:N_EXPERIMENTS
    ...
    push!(user_models_not_modeled_assumed, [Pair(change_consideration_distance(p.first, FOVIATION_DISTANCE), p.second) for p in particle_set])
...
user_models = user_models_not_modeled_assumed
@save "E0_anchoring_experiment_not_modeled_assumed.jld" home POIs user_models true_user_model
